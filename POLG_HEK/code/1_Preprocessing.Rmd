...
ggsave(plot = p5, "../plot/15_cor_ATAC_mtDepth.pdf", width = 9, height = 3)


library(ggpubr)
p6 <- ggscatter(
  HEK@meta.data, x = "nCount_ATAC", y = "mtDNA_depth",
  color = "condition", palette = color_vec,
  add = "reg.line"
  ) + facet_wrap(~condition) +
  stat_cor(
    aes(label = paste(..rr.label.., ..p.label.., sep = "~`,`~")), 
    label.y = 150) + stat_regline_equation(label.y = 200) + NoLegend()

ggsave(plot = p6, "../plot/15_cor_ATAC_mtDepth_equa.pdf", width = 9, height = 3)
