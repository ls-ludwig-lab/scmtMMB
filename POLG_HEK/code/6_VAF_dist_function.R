...
if (!dir.exists("../plot/Fig3_VAF_dist_plots")) dir.create("../plot/Fig3_VAF_dist_plots")

save_plot_pair <- function(plot_list, base_name) {
  # ggsave(filename = paste0("../plot/Fig3_VAF_dist_plots/", base_name, "_histogram.pdf"), plot = plot_list$hist, width = 2, height = 2)
  ggsave(filename = paste0("../plot/Fig3_VAF_dist_plots/", base_name, "_ecdf.pdf"), plot = plot_list$ecdf, width = 5, height = 5)
}

save_rank_plot <- function(meta_df, sample_id) {
  p <- plot_rank_ordered(meta_df, paste0(sample_id, " - Rank ordered mutations"))
  ggsave(filename = paste0("../plot/Fig3_VAF_dist_plots/", sample_id, "_rank_plot.pdf"), plot = p, width = 7, height = 5)
}

save_entropy_plot <- function(group_matrices, sample_id) {
  pdf(paste0("../plot/Fig3_VAF_dist_plots/", sample_id, "_entropy_boxplot.pdf"), width = 5.5, height = 5.5)
...
plot_variant <- function(df, variant, title, sampleName, umap_w = 4) {
  ...
  pdf_file_umap <- paste0("../plot/Fig3_VAF_dist_plots/", sampleName, "_", variant, "_UMAP.pdf")
  ...
  pdf_file_hist <- paste0("../plot/Fig3_VAF_dist_plots/", sampleName, "_", variant, "_hist.pdf")
